# -*- coding: utf-8 -*-
import plivo
# from .views import reply_source, reply_destination, menu_context # why isn't this working?????????
...
params = {
    'src': "reply_source",  # Sender's phone number with country code
    'dst': "reply_destination",  # Receiver's phone Number with country code
    'text' : u"menu_context", # Your SMS Text Message - English
